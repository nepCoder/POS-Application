...
using POS.Application.LLBL.EntityClasses;
using POS.Application.LLBL.HelperClasses;
using POS.Application.LLBL.RelationClasses;
using SD.LLBLGen.Pro.ORMSupportClasses;

namespace POS.Application.LLBL.FactoryClasses
{
	...
	{
		/// <summary>Gets the factory of the Entity type with the POS.Application.LLBL.EntityType value passed in</summary>
